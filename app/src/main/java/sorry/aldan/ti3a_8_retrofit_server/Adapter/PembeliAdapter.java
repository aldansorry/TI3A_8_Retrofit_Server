package sorry.aldan.ti3a_8_retrofit_server.Adapter;
...
import sorry.aldan.ti3a_8_retrofit_server.PutDelPembeliActivity;
import sorry.aldan.ti3a_8_retrofit_server.R;
import sorry.aldan.ti3a_8_retrofit_server.Rest.ApiClient;

/**
 * Created by 19lhamdulillah on 11/2/16.
 */
...
// .into(holder.mPhotoid);
            ...
            Glide.with(holder.itemView.getContext()).load(ApiClient.BASE_URL+"application/"+listPembeli.get(position
            ).getPhotoId())
                    .into(holder.mPhotoid);
        }else{
//
